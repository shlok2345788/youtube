...
const getUserCity = async (): Promise<string> => {
  try {
    ...
    console.warn("Could not fetch user city (network error):", error);
    return "Unknown";
  }
};
              ...
              <div className="flex-1 min-w-0 w-full">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-xs sm:text-sm text-muted-foreground hover:text-blue-600 disabled:opacity-50"
                  >
