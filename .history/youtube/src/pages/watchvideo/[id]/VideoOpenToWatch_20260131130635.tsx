    ...
    <div className="container mx-auto  px-4 py-6 max-w-7xl">
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 w-full">
          <div className="flex gap-6 justify-end">
            <CustomVideoPlayer
              ...
              onNextVideo={() => {
                ...
                const currentIndex = ALL_VIDEOS.findIndex(v => v._id === video._id);
                const nextIndex = (currentIndex + 1) % ALL_VIDEOS.length;
                const nextVideo = ALL_VIDEOS[nextIndex];
          ...
          <div id="comments-section" className="items-center mt-3">
            <ChannelInfo />
