    ...
    const handleSendOTP = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (errorMessage.includes('Email service not configured')) {
                toast.error('Email service not configured. Admin needs to set up email credentials.', {
                    duration: 5000,
                });
            } else if (errorMessage.includes('SMS service not configured')) {
                toast.error('SMS service not configured. Admin needs to set up SMS service.', {
                    duration: 5000,
                });
            } else {
