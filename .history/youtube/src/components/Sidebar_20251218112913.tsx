...
const Sidebar = ({ className = "" }: { className?: string }) => {
  ...
  console.log('User has channel:', user?.channelname);
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`w-64 bg-white border-r min-h-screen p-2 fixed md:relative z-50 transform transition-transform duration-300 ease-in-out md:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
          } ${className}`}
      >
