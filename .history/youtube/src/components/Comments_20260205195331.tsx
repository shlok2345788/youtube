...
const Comments = ({ videoId }: CommentsProps) => {
  ...
  return (
    <div className="space-y-6 mt-6 w-full px-2 sm:px-4 md:px-0 max-w-2xl mx-auto">
        ...
        <div className="flex gap-2 sm:gap-4 items-start">
          ...
          <div className="flex-1 space-y-2 min-w-0">
            <Textarea
              ...
              className="min-h-20 resize-none border-0 border-b-2 rounded-none focus-visible:ring-0 text-sm sm:text-base"
            />
      ...
      <div className="space-y-4">
        {comments.length === 0 ? (
          ...
          comments.map((comment) => (
            <div key={comment._id} className="flex gap-2 sm:gap-4 items-start">
              <Avatar className="w-9 h-9 sm:w-10 sm:h-10">
