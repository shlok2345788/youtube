            ...
            <form onSubmit={handleSearch} className="flex gap-2  max-w-4xl">
                <div>
                    <input type="search" value={searchQuery} placeholder="Search" onKeyPress={handleKeyPress} onChange={(e) => { e.target.value }}
                        className="rounded-l-full border-r-0 w-20xl focus-visible:ring-0"
                    />
                    <Button
                        type="submit"
                        className="rounded-r-full px-6 bg-gray-50 hover:bg-gray-100 text-gray700 border border-l-0"
                    >
